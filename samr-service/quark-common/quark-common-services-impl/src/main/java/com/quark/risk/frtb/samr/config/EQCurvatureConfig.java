...
import static com.quark.risk.frtb.samr.config.ConfigUtil.populateWithIntegerKeyAndDoubleValues;
...
public class EQCurvatureConfig {
	...
	@PostConstruct
	private void init() {
		populateWithIntegers(eqCurvatureBucketConfig, eqCurvatureBuckets);
		populateWithIntegerKeyAndDoubleValues(eqCurvatureBuckets, eqCurvatureRw, riskWeights);
