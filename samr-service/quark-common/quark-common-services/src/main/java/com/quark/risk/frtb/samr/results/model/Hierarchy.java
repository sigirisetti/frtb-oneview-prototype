package com.quark.risk.frtb.samr.results.model;

import com.quark.risk.frtb.samr.model.HierarchyFilters;
...
public class Hierarchy implements HierarchyFilters {
	...
	public void addHierarchyRow(com.quark.risk.frtb.samr.model.Hierarchy hierarchy) {
