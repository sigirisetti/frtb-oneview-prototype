...
import static com.uob.frtb.risk.samr.config.ConfigUtil.populateWithStringKeyAndDoubleValues;
...
public class DRCNonSecConfig {
	...
	private void init() {
		...
		ConfigUtil.populateWithStringKeyAndDoubleValues(creditRatings, drcIssuerRatingRwConfig, ratingRwMap);
		ConfigUtil.populateWithStringKeyAndDoubleValues(drcSeniority, drcSeniorityLgd, seniorityLgdMap);
	}
}
