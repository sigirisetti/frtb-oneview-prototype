...
import com.uob.frtb.risk.frtb.samr.csv.model.CRNonSecDeltaData;
import com.uob.frtb.risk.frtb.samr.model.TradeSensitivity;

public class CRNonSecDeltaCsvReader extends BaseSAMRCsvReader<TradeSensitivity> {

	public CRNonSecDeltaCsvReader(String csvName, CoreDao coreDao) {
	...
	public void setupCsvReader() {
		...
		reader = mapper.readerFor(CRNonSecDeltaData.class).with(schema);
	}
}
